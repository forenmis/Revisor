...
public class AuthorizationViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<Boolean> authLD = new MutableLiveData<>();
    ...
    public MutableLiveData<Boolean> getAuthLD() {
        return authLD;
    }
